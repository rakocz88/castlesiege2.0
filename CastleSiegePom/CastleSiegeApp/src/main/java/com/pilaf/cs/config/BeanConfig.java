...
import com.pilaf.cs.game.GameConfig;
...
@Configuration
@Import({ UserBeanConfiguration.class, NotificationBeanConfiguration.class, WebSocketConfig.class,
		GameSearchConfig.class, WebSecurityConfig.class, CacheConfig.class, GameConfig.class })
